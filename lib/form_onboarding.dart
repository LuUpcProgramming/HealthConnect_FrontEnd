...
void main() {
  runApp(const FormularioOnboardingApp ());
}

class FormularioOnboardingApp extends StatelessWidget {
  const FormularioOnboardingApp ({super.key});
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                HealthButton(
                  label: 'Ansiedad',
                  isSelected: selectedOptions.contains('Ansiedad'),
                ...
                HealthButton(
                  label: 'Estrés',
                  isSelected: selectedOptions.contains('Estrés'),
                ...
                HealthButton(
                  label: 'Cansancio',
                  isSelected: selectedOptions.contains('Cansancio'),
                ...
                HealthButton(
                  label: 'TDAH',
                  isSelected: selectedOptions.contains('TDAH'),
                ...
                HealthButton(
                  label: 'Depresión',
                  isSelected: selectedOptions.contains('Depresión'),
                ...
                HealthButton(
                  label: 'Insomnio',
                  isSelected: selectedOptions.contains('Insomnio'),
                ...
                HealthButton(
                  ...
                  isSelected: selectedOptions.contains('Dolores de cabeza'),
                ...
                HealthButton(
                  label: 'Mala Postura',
                  isSelected: selectedOptions.contains('Mala Postura'),
                ...
                HealthButton(
                  ...
                  isSelected: selectedOptions.contains('Mala Alimentación'),
                ...
                HealthButton(
                  label: 'Sedentarismo',
                  isSelected: selectedOptions.contains('Sedentarismo'),
                ...
                HealthButton(
                  ...
                  isSelected: selectedOptions.contains('Falta de Ejercicio'),
