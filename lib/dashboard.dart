...
class HomeScreen extends StatelessWidget {
  ...
  final String userImage = 'assets/images/user_image.png'; // Ruta a la imagen en assets
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  CircleAvatar(
                    backgroundImage: AssetImage(userImage), // Usamos AssetImage para la imagen local
                    radius: 20,
                  ),
...
class StatusBox extends StatelessWidget {
  ...
  const StatusBox({super.key, required this.title, required this.content, required this.subContent});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: [
          CircleAvatar(
            backgroundImage: AssetImage('assets/images/image.png'), // Usamos AssetImage para la imagen local
            radius: 20,
          ),
          SizedBox(width: 8),
          Column(
...
class PlanItem extends StatelessWidget {
  ...
  const PlanItem({super.key, required this.icon, required this.title, required this.text});
    ...
    return BottomAppBar(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.android, color: Colors.white), // Reemplazamos el ícono por uno válido
            onPressed: () {},
          ),
